...
class GeneralAgent(AgentPPO2):
    def __init__(self, domain, task, cfg, logger, dtype, device, num_threads, training=True, checkpoint=0):
        self.cfg = cfg
        self.logger = logger
        self.dtype = dtype
        self.device = device
    ...
    def setup_env(self, domain, task):
